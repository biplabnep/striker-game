...
const moreCategories: NavCategory[] = [
  {
    ...
    items: [
      ...
      { screen: 'squad_rotation_enhanced', icon: <RotateCcw className="h-5 w-5" />, label: 'Rotation+' },
      ...
      { screen: 'training_ground_enhanced', icon: <Warehouse className="h-5 w-5" />, label: 'Ground+' },
      ...
      { screen: 'set_piece_trainer_enhanced', icon: <Target className="h-5 w-5" />, label: 'SP Enhanced' },
  ...
  },
  {
    ...
    items: [
      ...
      { screen: 'stadium_atmosphere_enhanced', icon: <Building2 className="h-5 w-5" />, label: 'Atmosphere+' },
      { screen: 'player_career_timeline_enhanced', icon: <Route className="h-5 w-5" />, label: 'Timeline+' },
      ...
      { screen: 'sponsor_system_enhanced', icon: <Handshake className="h-5 w-5" />, label: 'Sponsors+' },
      ...
      { screen: 'career_events_enhanced', icon: <Sparkles className="h-5 w-5" />, label: 'Events+' },
      ...
      { screen: 'transfer_deadline_day_enhanced', icon: <AlarmClock className="h-5 w-5" />, label: 'Deadline+' },
  ...
  },
  {
    ...
    items: [
      ...
      { screen: 'daily_routine_enhanced', icon: <Calendar className="h-5 w-5" />, label: 'Routine+' },
  ...
  },
  {
    ...
    items: [
      ...
      { screen: 'media_interview_enhanced', icon: <Radio className="h-5 w-5" />, label: 'Interview+' },
